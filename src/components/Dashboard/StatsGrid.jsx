...
import { BarChart3, Target, Users, ShieldCheck, ArrowUpRight } from 'lucide-react';
        ...
        return (
          ...
          >
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className={`text-sm font-semibold ${ stats.trend === "up" ? "text-emerald-500"
                     : "text-red-500"}`}
                     >
                     {stats.change}</span>
            ...
            <div className="mt-4 h-2 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
              <div className={`w-full bg-gradient-to-r ${stats.color} rounded-full transition-all 
              duration-100`} 
