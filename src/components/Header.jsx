      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:block">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">Aggregated view of security alerts from various sources.</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          {/* toggle */}
          <button className="p-2.5 rounded-xl text-slate-600 dark:text-slate-slate-300
          ...
          <div className="flex items-center space-x-3 pl-3 border-l border-slate-200
           dark:border-slate-700">
            <img
               ...
               <div className="hidden md:block">
                <p className="text-sm font-medium text-slate-500 dark:text-slate-400">Anne Benita</p>
